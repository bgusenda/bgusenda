...
[![Skills](https://skills.syvixor.com/api/icons?i=linux,arch,android)](https://github.com/syvixor/skills-icons)
...
[![Skills](https://skills.syvixor.com/api/icons?i=reactnative,androidstudio,flutter,capacitor,expo,gradle)](https://github.com/syvixor/skills-icons)

### 📦 Tools, Editors & Productivity

[![Skills](https://skills.syvixor.com/api/icons?i=git,github,vscode,figma,obsidian,arduino,trello,canva,bash,npm,yarn,babel,swc)](https://github.com/syvixor/skills-icons)
...
| ------------- | ------------- | ------------- |
| <img src="https://i.imgur.com/Fh5ZIKG.png" width="60" style="border-radius: 8px;" alt="PhysApp Logo"> <br> Physapp | 🇺🇸 A mobile physics calculus resolver app. <br> 🇧🇷 Um aplicativo mobile resolvedor de cálculos de física. | ![Status](https://img.shields.io/badge/status-WIP-yellow) |
